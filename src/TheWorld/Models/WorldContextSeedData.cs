...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if(await this.userManager.FindByEmailAsync("yidahab@theworld.com") == null)
            {
                var user = new WorldUser()
                {
                    UserName = "yidahab",
                    Email = "yidahab@theworld.com"
                };
            ...
            if (!this.context.Trips.Any())
            {
                ...
                this.context.AddRange(usTrip.Stops);
                ...
                this.context.AddRange(worldTrip.Stops);
